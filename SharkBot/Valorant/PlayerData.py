...
class PlayerData:
    ...
    def __init__(self, data: dict[str, dict[str, int]]):
        self.data: dict[Valorant.Map.Map, dict[Valorant.Agent.Agent, int]] = {
    ...
    def get_agent_value(self, agent: Valorant.Agent.Agent, map: Valorant.Map.Map) -> int:
    ...
    def set_agent_value(self, agent: Valorant.Agent.Agent, map: Valorant.Map.Map, value: int):
